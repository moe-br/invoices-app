...
import { formatCurrency, formatTND } from '@/app/lib/utils';
import {
  XMarkIcon,
  DocumentPlusIcon,
  TrashIcon,
          ...
          <div className="space-y-6 bg-white p-8 rounded-2xl border border-slate-100 shadow-xl shadow-slate-100/50 relative overflow-hidden group transition-all hover:border-tunisia-red/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
               <div className="space-y-1">
                  ...
                  <p className="text-base font-black text-slate-900">{formatTND(hTAmount)}</p>
               </div>
               <div className="space-y-1 md:border-l md:border-slate-50 md:pl-6">
                  ...
                  <p className="text-base font-black text-slate-900 opacity-60">{formatTND(vatAmount + stampDuty)}</p>
               </div>
               <div className="space-y-1 md:pl-6">
                  ...
                  <p className="text-2xl font-black text-tunisia-red tracking-tight">{formatTND(totalTTC)}</p>
               </div>
            </div>
